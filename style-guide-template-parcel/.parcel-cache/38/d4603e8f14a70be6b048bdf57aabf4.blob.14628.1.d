...
.nav-is-visible .cd-nav-trigger span {
  ...
  background-color: rgba(239, 214, 172, 0);
}
...
.cd-navigation ul:nth-of-type(2) {
...
.btn.btn-outline {
  ...
  box-shadow: inset 0 0 0 1px #45a3d9;
}
...
input[type=text]:focus {
  border-color: #45a3d9;
  box-shadow: 0 0 6px rgba(69, 163, 217, 0.2);
}
